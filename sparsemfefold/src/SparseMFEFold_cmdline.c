/*
  ...
  gengetopt -F SparseMFEFold_cmdline -u
...
const char *gengetopt_args_info_purpose = "Time- and space-efficient sparsified minimum free energy folding of RNAs";

const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE "[options] [sequence]";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Read RNA sequence from stdin or cmdline; predict minimum\nfree energy and optimum structure using the time- and space-efficient\nMFE RNA folding algorithm of Will and Jabbari, 2015. The results are\nequivalent to RNAfold -d0, but the computation takes less time (for\nlong sequences) and much less space.";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->mark_candidates_help = gengetopt_args_info_help[3] ;
  args_info->noGC_help = gengetopt_args_info_help[4] ;
      ...
      switch (c)
        ...
        case 'm':	/* Represent candidate base pairs by square brackets.  */
          ...
          if (update_arg( 0 , 
              ...
              &(local_args_info.mark_candidates_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "mark-candidates", 'm',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "noGC") == 0)
          {
            ...
            if (update_arg( 0 , 
                ...
                &(local_args_info.noGC_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "noGC", '-',
                additional_error))
              goto failure;
