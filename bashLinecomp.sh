input=$1
file="/home/mgray7/output2/linearfold/fasta/$input.txt";
exec 5<$file
i=0;
...
# /usr/bin/time -o out.txt -f "%e\t%M" ./build/SparseRNAFolD -d2 $line;
./build/SparseRNAFolD -d1 $line > out.txt;
...
cat "/home/mgray7/SparseRNAFolD/out.txt" >> "/home/mgray7/output2/linearfold/results/$input.txt"
fi
#   
i=$((i+1));
done 
