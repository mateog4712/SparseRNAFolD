...
class TraceArrow {
    ...
    cand_pos_tu count_; //!< counts how many trace arrows point to the source
  public:
    /**
     ...
     */
    TraceArrow(cand_pos_tu i, cand_pos_tu j, cand_pos_tu k, cand_pos_tu l, energy_t e) : k_(k - i), l_(j - l), energy_(e), count_(0) {}
    ...
    cand_pos_tu k(cand_pos_tu i) const { return k_ + i; }
    cand_pos_tu l(cand_pos_tu j) const { return j - l_; }
